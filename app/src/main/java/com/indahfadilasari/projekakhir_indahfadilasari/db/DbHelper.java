package com.indahfadilasari.projekakhir_indahfadilasari.db;
...
import com.indahfadilasari.projekakhir_indahfadilasari.model.Masyarakat;

import java.util.ArrayList;

public class DbHelper extends SQLiteOpenHelper {
    public static final String DATABASE_NAME = "dbmasyarakat";
    ...
    private static final String CREATE_TABLE_MASYARAKAT = "CREATE TABLE " + TABLE_STD + " ("
    ...
    public void onCreate(SQLiteDatabase db) {
        // Perintah DDL untuk Create Tabel
        db.execSQL(CREATE_TABLE_MASYARAKAT);
    }

    @Override
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        // Perintah DDL untuk Upgrade Tabel, dalam hal ini menghapus Tabel
